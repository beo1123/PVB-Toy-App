...
class ProductDiscountListPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    int? id = ref.read(discountSelected.notifier).state.id;
    var categoryApiResult = ref.watch(_fetchCategory);
    var productApiResult = ref.watch(_fetchProductByDiscount(id));
                ...
                children: [
                  Container(
                      ...
                      child: Padding(
                        ...
                        child: Center(
                            child: Text(
                                '${ref.read(discountSelected.notifier).state.name}')),
                      ))
                ],
              ),
            ],
