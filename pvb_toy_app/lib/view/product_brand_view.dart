...
class ProductBrandListPage extends ConsumerWidget {
  ...
  final _fetchProductBrand =
      FutureProvider.family<List<myToy>, int?>((ref, id) async {
    var result = await fetchProductByBrand(id);
    return result;
  });
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    int? idbrand = ref.read(brandSelected.notifier).state.id;
    var categoryApiResult = ref.watch(_fetchCategory);
    var productBrandApiResult = ref.watch(_fetchProductBrand(idbrand));
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        children: [
                ...
                children: [
                  Container(
                      ...
                      child: Padding(
                        ...
                        child: Center(
                            child: Text(
                                '${ref.read(brandSelected.notifier).state.brand}')),
                      ))
                ],
              ),
            ],
          ...
          Expanded(
            child: productBrandApiResult.when(
